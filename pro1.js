...
// @version      1000.MAX.3
// @description  XHR/Fetch Prototype Interceptor, Ultra OLED TV Engine, Deep Match Auto-Next, Smart Remote D-Pad, Native CUB VIP Sync
// @match        *://*/*
...
(function() {
    ...
    Object.defineProperty(window, 'Lampa', {
        ...
        set: function(val) {
            if (val && !val.__goldSolidMod) {
                val.__goldSolidMod = true;
    ...
    function injectUI() {
        ...
        var css = 
            ...
            'html body .button, html body .simple-button, html body .full-start__button { border-radius: 20px !important; background-color: rgba(255,255,255,0.12) !important; font-weight: 500 !important; transition: transform 0.1s ease, background-color 0.1s ease !important; } ' +
